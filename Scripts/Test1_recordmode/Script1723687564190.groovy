 ...
 * Service/input_Demo account_form-control'), 'ThisIsNotAPassword')
 * 
 * WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare
 * Service/input_Demo account_form-control'))
 * 
 * WebUI.doubleClick(findTestObject('Object Repository/Page_CURA Healthcare
 * Service/input_Demo account_form-control'))
 */
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'this is a demo')
